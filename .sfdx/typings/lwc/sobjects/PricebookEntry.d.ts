...
declare module "@salesforce/schema/PricebookEntry.vlocity_cmt__FloorPrice__c" {
  const vlocity_cmt__FloorPrice__c:number;
  export default vlocity_cmt__FloorPrice__c;
}
declare module "@salesforce/schema/PricebookEntry.vlocity_cmt__OverageCharge__c" {
  const vlocity_cmt__OverageCharge__c:number;
  export default vlocity_cmt__OverageCharge__c;
}
declare module "@salesforce/schema/PricebookEntry.vlocity_cmt__OverageUOM__c" {
  const vlocity_cmt__OverageUOM__c:string;
  export default vlocity_cmt__OverageUOM__c;
}
declare module "@salesforce/schema/PricebookEntry.vlocity_cmt__RecurringPrice__c" {
  const vlocity_cmt__RecurringPrice__c:number;
  export default vlocity_cmt__RecurringPrice__c;
}
declare module "@salesforce/schema/PricebookEntry.vlocity_cmt__RecurringUOM__c" {
