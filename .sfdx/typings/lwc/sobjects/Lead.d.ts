...
declare module "@salesforce/schema/Lead.vlocity_cmt__CurrentGenerators__c" {
  const vlocity_cmt__CurrentGenerators__c:string;
  export default vlocity_cmt__CurrentGenerators__c;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__NumberofLocations__c" {
  const vlocity_cmt__NumberofLocations__c:number;
  export default vlocity_cmt__NumberofLocations__c;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__PremisesId__r" {
  const vlocity_cmt__PremisesId__r:any;
  export default vlocity_cmt__PremisesId__r;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__PremisesId__c" {
  const vlocity_cmt__PremisesId__c:any;
  export default vlocity_cmt__PremisesId__c;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__Primary__c" {
  const vlocity_cmt__Primary__c:string;
  export default vlocity_cmt__Primary__c;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__ProductInterestData__c" {
  const vlocity_cmt__ProductInterestData__c:string;
  export default vlocity_cmt__ProductInterestData__c;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__ProductInterest__c" {
  const vlocity_cmt__ProductInterest__c:string;
  export default vlocity_cmt__ProductInterest__c;
}
declare module "@salesforce/schema/Lead.vlocity_cmt__SICCode__c" {
  const vlocity_cmt__SICCode__c:string;
  export default vlocity_cmt__SICCode__c;
}
