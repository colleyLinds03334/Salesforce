...
declare module "@salesforce/schema/User.UserPreferencesHideBrowseProductRedirectConfirmation" {
  const UserPreferencesHideBrowseProductRedirectConfirmation:boolean;
  export default UserPreferencesHideBrowseProductRedirectConfirmation;
}
declare module "@salesforce/schema/User.UserPreferencesHideOnlineSalesAppWelcomeMat" {
  const UserPreferencesHideOnlineSalesAppWelcomeMat:boolean;
  export default UserPreferencesHideOnlineSalesAppWelcomeMat;
}
...
declare module "@salesforce/schema/User.sf_devops__GitHub_Primary_Email_Address__c" {
  const sf_devops__GitHub_Primary_Email_Address__c:string;
  export default sf_devops__GitHub_Primary_Email_Address__c;
}
declare module "@salesforce/schema/User.vlocity_cmt__DocuSignEmail__c" {
  const vlocity_cmt__DocuSignEmail__c:string;
  export default vlocity_cmt__DocuSignEmail__c;
}
declare module "@salesforce/schema/User.vlocity_cmt__DocuSignNamedCredential__c" {
  const vlocity_cmt__DocuSignNamedCredential__c:string;
  export default vlocity_cmt__DocuSignNamedCredential__c;
}
declare module "@salesforce/schema/User.vlocity_cmt__GlobalKey__c" {
  const vlocity_cmt__GlobalKey__c:string;
  export default vlocity_cmt__GlobalKey__c;
}
declare module "@salesforce/schema/User.vlocity_cmt__OMplusSyncEnabled__c" {
  const vlocity_cmt__OMplusSyncEnabled__c:boolean;
  export default vlocity_cmt__OMplusSyncEnabled__c;
}
declare module "@salesforce/schema/User.vlocity_cmt__OMplus_Enabled__c" {
  const vlocity_cmt__OMplus_Enabled__c:boolean;
  export default vlocity_cmt__OMplus_Enabled__c;
}
declare module "@salesforce/schema/User.vlocity_cmt__StoreAssociateStatus__c" {
  const vlocity_cmt__StoreAssociateStatus__c:string;
  export default vlocity_cmt__StoreAssociateStatus__c;
}
