...
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__ActionType__c" {
  const vlocity_cmt__ActionType__c:string;
  export default vlocity_cmt__ActionType__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__CampaignName__c" {
  const vlocity_cmt__CampaignName__c:string;
  export default vlocity_cmt__CampaignName__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__CampaignStatus__c" {
  const vlocity_cmt__CampaignStatus__c:string;
  export default vlocity_cmt__CampaignStatus__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__CampaignType__c" {
  const vlocity_cmt__CampaignType__c:string;
  export default vlocity_cmt__CampaignType__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__LastCallDate__c" {
  const vlocity_cmt__LastCallDate__c:any;
  export default vlocity_cmt__LastCallDate__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__StartDate__c" {
  const vlocity_cmt__StartDate__c:any;
  export default vlocity_cmt__StartDate__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__TargetCallDate__c" {
  const vlocity_cmt__TargetCallDate__c:any;
  export default vlocity_cmt__TargetCallDate__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__CampaignOmniScriptURL__c" {
  const vlocity_cmt__CampaignOmniScriptURL__c:string;
  export default vlocity_cmt__CampaignOmniScriptURL__c;
}
declare module "@salesforce/schema/CampaignMember.vlocity_cmt__EmailTemplate__c" {
  const vlocity_cmt__EmailTemplate__c:string;
  export default vlocity_cmt__EmailTemplate__c;
}
